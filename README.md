...
3.  Install dependencies:
    ...
    npm install
    ```
4.  Set up the `DATABASE_URL` environment variable to connect to your local PostgreSQL instance (e.g., `postgresql://localhost/gilmore_db`).
...
- `create_challenges.py`: Python script to dynamically generate zip file challenges for learning modules.
- `create_tier4_projects.py`: Python script to dynamically generate 20 Tier 4 project zip file challenges.
- `add_download_buttons.py`: Python script to automate adding download buttons to the project's HTML module pages.
