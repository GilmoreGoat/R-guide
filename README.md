...
- `create_challenges.py`: Python script to dynamically generate challenge zip files.
- `add_download_buttons.py`: Python script to add download buttons to HTML pages.
- `fix_fouc.py`: Python script to inject a dark theme script into HTML heads to prevent Flash of Unstyled Content (FOUC).
