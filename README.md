...
- `create_challenges.py`: Python script to generate challenge zip files.
...
- `fix_fouc.py`: Python script to inject a synchronous script to prevent Flash of Unstyled Content (FOUC).
