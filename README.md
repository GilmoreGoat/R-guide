...
#### End-to-End Tests
Verifies WebR loading and page interactions using Playwright. Requires a local Node server running with a database connection and may require `npx playwright install chromium`.
