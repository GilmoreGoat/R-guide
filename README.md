...
- `create_challenges.py`: Python script to dynamically generate module challenge zip files.
- `add_download_buttons.py`: Python script to add download buttons to HTML pages.
- `fix_fouc.py`: Python script to inject dark theme script in HTML files to prevent Flash of Unstyled Content (FOUC).
