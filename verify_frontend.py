...
def run():
    with sync_playwright() as p:
        ...
        page.goto("http://localhost:8080/modules/oop.html")
        page.wait_for_selector("text=The Dragonfly Ledger", timeout=10000)
        ...
        page.goto("http://localhost:8080/modules/debugging.html")
        page.wait_for_selector("text=Friday Night Dinner", timeout=10000)
        ...
        page.goto("http://localhost:8080/modules/functional.html")
        page.wait_for_selector("text=Sookie's Recipe Scaling", timeout=10000)
